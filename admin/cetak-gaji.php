...
$pdf->SetX(5);
$pdf->Cell(40,8,'NI K : '.$nik,0,0,'L',1);
$pdf->SetX(45);
...
//$pdf->Cell(45,8,'Order : '.$tgl,0,0,'R',1);
$pdf->Ln();
$Y_Fields_Name_position = 140;
$pdf->SetY($Y_Fields_Name_position);
$pdf->SetX(5);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(10);
$pdf->Cell(30,10,'CV. Denata Printing',0,0,'C');
$pdf->Cell(105);
$pdf->Cell(30,15,'Karyawan',0,0,'C');
$pdf->Ln(20);
$pdf->Cell(10);
